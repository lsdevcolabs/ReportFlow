...
const mockClients = [
  { id: "1", name: "Acme Corp", brandColor: "#3B82F6" },
  { id: "2", name: "TechStart Inc", brandColor: "#8B5CF6" },
  { id: "3", name: "GreenLeaf Co", brandColor: "#10B981" },
];
...
function NewReportPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Would redirect to the report detail page
  };
                  ...
                  {!selectedClient || !formData.title ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="font-medium" style={{ color: selectedClient.brandColor }}>
                          {selectedClient.name}
                        </span>
                      </div>
